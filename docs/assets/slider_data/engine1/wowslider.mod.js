...
(function (b) {
    ...
    b.fn.wowSlider = function (p) {
      ...
      if (j.hasClass("fullscreen")) {
        ...
        function C(Q) {
          if (h) {
            ...
            b(Q)
              .children()
              .css({ top: (window.screen.availHeight - O / P) / 2 });
            return q === ""
              ? Q.requestFullScreen()
              : Q[q + "RequestFullScreen"]();
          } else {
            if (!Q) {
              return;
            }
            ...
            var i = b("<div id='viewfullscreen'/>").css({
              position: "absolute",
              width: "100%",
              height: "100%",
            ...
            i.append(
              b("<div id='container'/>")
                .css({ "margin-top": (b(window).height() - O / P) / 2 })
                .append(b(Q).children().css({ width: O, "max-width": "95%" }))
            );
            (function () {
              ...
              b(".ws_shadow")
                ...
                .append(b("<img src=" + R + "></img>").css("width", "100%"));
            })();
        ...
        function r(i) {
          if (h) {
            ...
            b("#viewfullscreen>#container")
              .children()
              .css({ width: "", "max-width": o })
              .appendTo(b(i));
        ...
        var A = b(
          '<a href="#" class="min ws_fulscreen" style="display: block;"></a>'
        );
        A.click(function () {
          H(d);
        });
      ...
      if (j.hasClass("playpause")) {
        var f = b(
          '<a href="#" class="ws_playpause" style="display: block;"></a>'
        );
        if (N) {
          f.addClass("pause");
        } else {
  ...
  (function (b) {
    ...
    b.fn.wowSlider = function (p) {
      ...
      if (j.hasClass("fullscreen")) {
        ...
        var A = b(
          '<a href="#" class="min ws_fullscreen" style="display: block;"></a>'
        );
        A.click(function () {
          H(d);
        });
      ...
      if (j.hasClass("playpause")) {
        var f = b(
          '<a href="#" class="ws_playpause ws_hovershow" style="display: block;"></a>'
        );
        if (N) {
          f.addClass("pause");
        } else {
